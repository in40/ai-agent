...
# Now import the modules after setting the environment variable
from ai_agent import AIAgent
from models.sql_executor import SQLExecutor
from utils.multi_database_manager import multi_db_manager, DatabaseManager
...
def main():
    ...
    # Verify that the DISABLE_DATABASES setting is correctly set
